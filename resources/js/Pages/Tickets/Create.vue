...
const selectDepartment = async (departmentId) => {
    ...
    try {
        ...
        const response = await axios.get(
            `${window.APP_URL}/departments/${departmentId}/units`
        );
...
const selectUnit = async (unitId) => {
    ...
    try {
        ...
        const response = await axios.get(
            `${window.APP_URL}/units/${unitId}/topics`
        );
                    ...
                    <div class="p-8 bg-white border-b border-gray-200">
                        ...
                        <div v-if="!selectedDepartment" class="space-y-6">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <h3
                                        class="mt-4 text-xl font-semibold text-center text-blue-800"
                                    >
                                        {{ dept.name }}
                                    </h3>
                                    <p
                        ...
                        <div v-else-if="!selectedUnit" class="space-y-6">
                            ...
                            <h2
                                class="text-xl font-semibold text-center text-gray-800"
                            >
                                Which support unit should handle this?
                            </h2>
                            <div
                                v-if="loadingUnits"
                                class="flex justify-center py-8"
                            ...
                            >
                                ...
                                >
                                    <h3
                                        class="text-xl font-semibold text-center text-blue-800"
                                    >
                                        {{ unit.name }}
                                    </h3>
                                    <p
                        ...
                        <div v-else-if="!selectedTopic" class="space-y-6">
                            ...
                            >
                                ...
                                >
                                    <h3
                                        class="text-lg font-semibold text-center text-blue-800"
                                    >
                                        {{ topic.name }}
                                    </h3>
                                    <p
                                        class="mt-1 text-xs text-center text-gray-600"
                                    >
                            ...
                            <div class="space-y-6">
                                    ...
                                    <div class="mt-1 space-y-2">
                                        ...
                                        >
                                            <input
                                                ...
                                                :value="p.value"
                                                type="radio"
                                                class="w-4 h-4 border-gray-300 focus:ring-blue-500"
                                            />
                                            <label
                                                :for="`priority-${p.value}`"
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">
                                        You can upload multiple files (max 10MB
                                        each)
                                    </p>
                                    <InputError
