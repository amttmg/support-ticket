            ...
            <div class="w-full max-w-4xl mx-auto sm:px-6 lg:px-8">
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-xl">
                    ...
                    <div v-else-if="!selectedTopic" class="space-y-6">
                        <div class="flex items-center justify-between">
                            <button @click="goBackToUnits" class="flex items-center text-sm font-medium text-blue-600 hover:text-blue-800">
                        ...
                        <div v-if="filteredTopics.length === 0" class="py-8 text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 mx-auto text-gray-400" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
