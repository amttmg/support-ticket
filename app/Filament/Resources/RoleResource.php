...
class RoleResource extends Resource
{
    ...
    public static function getPermissions(?string $guardName = null)
    {
        ...
        return $query
            ...
            ->mapWithKeys(function ($permissions, $resource) {
                // Map permissions to an array where keys are IDs and values are names
                return [
                    $resource => $permissions->mapWithKeys(function ($permission) {
