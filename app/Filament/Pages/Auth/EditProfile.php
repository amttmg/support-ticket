        ...
        return [
            'form' => $this->form(
                $this->makeForm()
                    ->schema([
                        // Profile Section
                        \Filament\Forms\Components\Section::make('Profile')
                            ->schema([
                                $this->getNameFormComponent()->readonly()->columnSpan(1),
                                $this->getEmailFormComponent()->readonly()->columnSpan(1),
                                TextInput::make('mobile_number')->columnSpan(1),
                                TextInput::make('emp_no')->label('Employee Number')->readOnly()->columnSpan(1),
                            ])
                            ->columns(2),

                        // Password Section
                        \Filament\Forms\Components\Section::make('Password Change')
                            ->schema([
